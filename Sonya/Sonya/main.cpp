...
void print(int g, artical *newartical)
{
    ...
    cout << "----------------------------------------------------------" << '|' << endl;
    cout << setfill(' ') << setw(20) << left << "√Ó‰ " << '|' << setfill(' ') << setw(37) << newartical[g].year1 << right << '|' << endl;
    cout << "----------------------------------------------------------" << '|' << endl;
    ...
    cout << "----------------------------------------------------------" << '|' << endl;
    cout << setfill(' ') << setw(20) << left << "Õ‡Á‚‡ÌËÂ ÒÚ‡Ú¸Ë" << '|' << setfill(' ') << setw(37) << newartical[g].nazvS << right << '|' << endl;
    cout << "__________________________________________________________" << '|' << endl;
